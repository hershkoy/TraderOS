...
**Latest (2026-09-02):** causal **walk-replay** vs full-series batch on one name (`replay_channel_touch_walk.py`). AAPL 1d H2 resist-break: batch 2 fills matched exactly; walk added **2021-11-30** (H2 2021-09-07, +0.88%) that the omniscient detector never armed. See [walk-replay](edge_hunt/channel_touch/2026-09-02_channel_touch_walk_replay.md).
...
| Walk-replay (2026-09-02) | Feed detector bars `0..t` only, compare to `trades_for_symbol` on the full series. AAPL 1d: **2/2 batch fills match**; walk-only 2021-11-30. CLI: `scripts/research/replay_channel_touch_walk.py --symbol AAPL`. See [walk-replay](edge_hunt/channel_touch/2026-09-02_channel_touch_walk_replay.md) |

...
**Latest (2026-09-05):** `/hot` **Bought** column + tab tracks live ATR k=2 (1.5%–6%) + 10% trail from Alpaca last; stop hit fires **SELL NOW** (browser + Telegram). See [Bought tab](edge_hunt/channel_touch/2026-09-05_channel_touch_hot_bought.md).

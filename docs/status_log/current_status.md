...
| H2 resist-break (2026-08-29) | Fill close-above-resistance after H2 instead of cancelling. Sleeve span365 **n=2253 E +2.80 PF 2.21** (all years +). **Keeper + sleeve, re-RS:** n=1467 E **+2.26** PF **1.86**. Soft-promote as a **second book** (not L3 nightly; skip in-channel / RSI 50). HTML: `reports/ascending_channels/current_best/1d_h2_resist_break.html` and `1d_keeper_plus_h2_resist_break.html`. MGNI 2019-11-15 was L2 before H2; 2020-03-06 stop is correct; 2020-10-13 break +4.3% in 2d (span 560, not in 365). See [H2 resist-break](edge_hunt/channel_touch/2026-08-29_channel_touch_h2_resist_break.md) |
...
- **Next (optional):** Channel-touch 15m robustness (drop-top-N/bootstrap) on the 2026-08-29 wait12 keeper before expanding past 300 names; H2 resist-break drop-top-N / live resistance alerts; portfolio max-open in live sizing; ADV-tiered friction.

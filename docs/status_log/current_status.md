...
| 1d crowding (2026-09-05) | Unique-symbol equal-dollar concurrent **max 85 / med 18** — not a live book. Same-day n=6+ fills drag (2020-21 E −2.02). **cap 2/day by wait** (not RS): **n=933 E +3.01 PF 2.25** vs 1239 / +2.27 / 1.92 (those n/E/PF are **pre-`_as_session_date`**). max_open 8 wait n=338 E +3.13 PF 2.29 but 2022-23 weaker vs baseline (capital, not quality). Soft-promote cap-2 wait as an optional cross-symbol cap; do not replace unique-symbol nightly or HTML until chosen **and** next-mid is rebuilt. See [crowding](edge_hunt/channel_touch/2026-09-05_channel_touch_1d_crowding.md) |
...
| 1d next-mid session date (2026-09-05) | Daily midnight UTC must stay the calendar date for the 15m join. Pre-fix HTML n=1239 used prior-session 15m (RDWR 24.64). **Rebuild next-mid before treating HTML / crowding as honest.** See [session date](edge_hunt/channel_touch/2026-09-05_channel_touch_session_date.md) |

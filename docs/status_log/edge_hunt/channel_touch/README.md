...
| 2026-09-06 | [1d HTML out of current_best (unrealistic entry)](2026-09-06_channel_touch_1d_out_of_current_best.md) |
...
| 2026-09-06 | [1d close-cross + trail MAE (RDWR)](2026-09-06_channel_touch_close_cross_mae.md) |
| 2026-09-07 | [Close-cross MAE ridge 50 then 300 (year split)](2026-09-07_channel_touch_close_cross_mae_ridge.md) |
| 2026-09-07 | [H2 close-confirm + formation containment](2026-09-07_channel_touch_h2_close_confirm_formation.md) |
...
- **1d next-mid HTML (2026-09-05 / rebuilt 2026-09-06, not current_best):** pre-fix unique **n=1239 E +2.27 PF 1.92** used the wrong 15m session. **Honest `_as_session_date` unique span365 + shakeout n=1986 E +2.24 PF 1.89** (parent 1247 / extras 739; RS top1 n=916 E +2.09 PF 1.81). RDWR 2025-06-13 wild-cancels. Nightly scanner is still **unrealistic close / rail-clip**. See [session date](2026-09-05_channel_touch_session_date.md), [rebuild](2026-09-06_channel_touch_next_mid_session_date.md).
- **1d open-cross fill (2026-09-05):** `--realistic-fill-mode open-cross` — first IB 15m **open above resist**, fill at that bar's **close**. Unique span365 + shakeout **n=2845 E +2.06 PF 1.775** (parent 1906 / extras 939; all year buckets +; 2022-23 PF 1.36). Beats occupancy of next-mid (n=1239) but loses E/PF vs next-mid +2.27 / 1.92 and vs close-fill +2.40 / 2.02. RDWR 2025-06-13 is **25.71 @ 09:45 ET** (not 24.64). **No promote.** Nightly stays close fills. Not `current_best`. See [open-cross](2026-09-05_channel_touch_open_cross.md).
